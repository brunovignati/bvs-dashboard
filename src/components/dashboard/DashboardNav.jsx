...
import { BarChart3, Mail, ShoppingCart, Bell, Users, Layers, FileSearch, GitMerge, Calendar, UserCheck, ChevronLeft, ChevronRight, Sparkles, Database, Globe, Store, Instagram, Facebook, Video, LineChart } from "lucide-react";
...
const sections = [
  ...
  { id: "channels",     label: "Canales",      icon: Store },
