...
export default function Operaciones({ index, total }) {
  return (
    <div className="space-y-4">
      <DomainHeader title="Salud de envío" objetivo="Que la maquinaria de envío de email funcione sin roturas (volumen y entregabilidad)." index={index} total={total} />
