      ...
      <div className="h-56">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={series} margin={{ top: 5, right: 8, left: 4, bottom: 0 }}>
            ...
            {std > 0 && <ReferenceArea y1={lo} y2={hi} fill="hsl(200,85%,54%)" fillOpacity={0.06} />}
            <Area type="monotone" dataKey="value" stroke="hsl(200,95%,40%)" fill="hsl(200,95%,40%)" fillOpacity={0.12} strokeWidth={1.5} dot={false} />
          </ComposedChart>
        </ResponsiveContainer>
      </div>
    </EvidenceCard>
