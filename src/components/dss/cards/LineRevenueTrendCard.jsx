...
export default function LineRevenueTrendCard({ delay }) {
  ...
  return (
    <EvidenceCard sources={["connectif"]}
      ...
      delay={delay}
      note="Revenue mensual por línea de negocio: Nutracéuticos (Connectif · monthly_metrics) + BVS Vet Shop (Connectif · compradores). Apilado = total del negocio. Corta en el fin del periodo seleccionado."
    >
      {hasData && (
