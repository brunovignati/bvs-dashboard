      ...
      <div className="h-48">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={rows} margin={{ top:5, right:8, left:4, bottom:0 }}>
            ...
            <Line type="monotone" dataKey="Instagram" stroke="hsl(330,80%,55%)" strokeWidth={1.8} dot={false} connectNulls />
            <Line type="monotone" dataKey="Facebook" stroke="hsl(217,91%,60%)" strokeWidth={1.8} dot={false} connectNulls />
