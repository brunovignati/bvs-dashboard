      ...
      <div className={CHART_H}>
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={rows} margin={{ top: 5, right: 8, left: 4, bottom: 0 }}>
            ...
            <Bar yAxisId="p" dataKey="presion" name="Presión (env./suscriptor)" fill="hsl(200,72%,66%)" radius={[2, 2, 0, 0]} maxBarSize={22} />
            <Line yAxisId="r" dataKey="rate" name="Tasa de baja" type="monotone" stroke="hsl(200,95%,40%)" strokeWidth={2.2} dot={false} />
          </ComposedChart>
        </ResponsiveContainer>
      </div>
    </EvidenceCard>
